...
class SettingsWindow(QDialog):
    def __init__(self, slot__save__btn=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._slot__save__btn = slot__save__btn
    ...
    def _create_settings_for_database(self):
        ...
        db_path__label.setFixedSize(240, 15)
        ...
        db_file__label = QLabel('Имя файла базы данных: ', self)
    ...
    def _create_settings_for_socket(self):
        port__label = QLabel('Номер порта для соединений:', self)
    ...
    def _create_save_btn(self):
        ...
        if self._slot__save__btn:
            save__btn.clicked.connect(self._slot__save__btn)


# -----------------------------------------------------------------------------
def __slot__save__btn():
...
def __test_settings_window(argv):
    ...
    window = SettingsWindow(slot__save__btn=__slot__save__btn)

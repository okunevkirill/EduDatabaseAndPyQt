...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        MainClientWindow.resize(756, 568)
        ...
        self.btn_add_contact.setGeometry(QtCore.QRect(10, 440, 150, 31))
        self.btn_add_contact.setObjectName("btn_add_contact")
        self.btn_remove_contact = QtWidgets.QPushButton(self.centralwidget)
        self.btn_remove_contact.setGeometry(QtCore.QRect(10, 480, 150, 31))
        ...
        self.label_new_message.setGeometry(QtCore.QRect(300, 330, 411, 16))
        ...
        self.btn_send.setGeometry(QtCore.QRect(560, 450, 180, 31))
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(370, 450, 180, 31))
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Клиентская часть мессенджера"))
